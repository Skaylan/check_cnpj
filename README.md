...
É nescessario adicionar um arquivo .env na raiz do projeto econfgurar com uma variavel: SECRET_KEY = '(SUA KEY)'
...
app com o modo debug ativado, para desativar vá no arquivo run.py e na linha altere o app.run(debug=True) para app.run(debug=False)
